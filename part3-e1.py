...
def plot_bandwidth_histogram(bandwidths, bin_width):
    ...
    plt.savefig('part3-e2-nandan-room-my-room-buffer_bandwidth_histogram.png')

# Main execution
if __name__ == "__main__":
    file_path = 'part3-e2-nandan-room-my-room-buffer'  # Replace with your actual file path
