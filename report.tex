...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{part3-e2-my-room-sl-buffer_bandwidth_histogram.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{part3-e2-nandan-room-my-room-buffer_bandwidth_histogram.png}
